...
public class RadialMenuController : MonoBehaviour {
	...
	void Start () {
        ...
        GameObject.Find("Menu").transform.localScale = new Vector3(0, 1, 0);
    ...
    {
        Destroy(GameObject.Find("center_menu"));
        open = !open;
    ...
    public void ItemClick(GameObject gameObject)
    {
        ...
        clone.GetComponent<RectTransform>().sizeDelta = new Vector2(35,35);
    }
    ...
    private IEnumerator ZoomOutMenu()
    {
        ...
        while (loops < 100)
        {
            ...
            cylinder.transform.localScale = new Vector3(loops, 1, loops);
            loops++;
        }
    }

    public GameObject etCurrentItem()
    {
